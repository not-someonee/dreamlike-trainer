...
def create_unet_diffusers_config(v2, res):
  """
...
def load_models_from_stable_diffusion_checkpoint(v2, ckpt_path, resolution, dtype=None):
  ...
  unet_config = create_unet_diffusers_config(v2, resolution)
